...
- a matching **bounds module** (`*_bounds.py`) that implements the training loop and the bound estimators.
 ...
 <img src="assets/bound-cifar.jpg" width="200">  <img src="assets/bound-fmnist.jpg" width="200">  <img src="assets/bound-mnist-cnn.jpg" width="200">  <img src="assets/bound-mnist-mlp.jpg" width="200"> 
